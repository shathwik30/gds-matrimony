    ...
    <div className="from-muted/30 to-background min-h-screen bg-gradient-to-b">
      ...
      <section className="py-12 sm:py-16 md:py-28">
        <div className="container-wide px-4 text-center sm:px-6 md:px-8">
          <div className="bg-primary/10 shadow-premium-sm mb-4 inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm sm:mb-6 sm:px-5">
            <Crown className="text-primary h-4 w-4" />
            <span className="text-primary font-semibold">Choose Your Perfect Plan</span>
          </div>
          <h1 className="mb-4 text-2xl font-bold tracking-tight sm:mb-6 sm:text-4xl md:text-6xl">
            Find Your Life Partner with <span className="text-brand">Premium Membership</span>
          </h1>
          <p className="text-muted-foreground mx-auto max-w-3xl text-base leading-relaxed sm:text-lg md:text-xl">
            Unlock unlimited connections, verified profiles, and exclusive features to accelerate
            your journey to finding true love.
          </p>
        </div>
      </section>
                ...
                >
                  {isPopular && (
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                      <Badge className="bg-brand shadow-premium-md">Most Popular</Badge>
                    </div>
                  )}
                  ...
                  <CardHeader className="pb-4 text-center">
                    ...
                    <CardDescription className="mt-3 space-y-1">
                      <span className="text-foreground block text-3xl font-bold sm:text-4xl">
                  ...
                  <CardContent className="space-y-3 px-6">
                    <ul className="space-y-3">
                      ...
                      <li className="flex items-center gap-3 text-sm">
                        ...
                        <span>
                          <strong>
                            {plan.features.contactViews === 9999 ||
                            plan.features.contactViews === -1
                              ? "Unlimited"
                      ...
                      {plan.features.profileBoosts > 0 && (
                        <li className="flex items-center gap-3 text-sm">
                          <Check className="h-5 w-5 flex-shrink-0 text-green-500" />
                          <span>
                            <strong>{plan.features.profileBoosts}</strong>{" "}
                            {pluralize("profile boost", plan.features.profileBoosts)}
                          </span>
                        </li>
                      )}
      ...
      <section className="bg-card py-12 sm:py-16 md:py-20">
        <div className="container-wide px-4 sm:px-6 md:px-8">
          <div className="mb-8 text-center sm:mb-12 md:mb-16">
            <h2 className="mb-4 text-xl font-bold tracking-tight sm:mb-6 sm:text-3xl md:text-5xl">
              Why Choose Premium?
            </h2>
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 md:grid-cols-3 md:gap-8">
            <Card variant="elevated" className="group text-center">
              <CardContent className="p-4 sm:p-6 md:p-8">
                <div className="from-primary/20 to-primary/10 shadow-premium-md mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br transition-transform group-hover:scale-110 sm:mb-6 sm:h-16 sm:w-16">
                  <Crown className="text-primary h-6 w-6 sm:h-8 sm:w-8" />
                </div>
                <h3 className="mb-2 text-lg font-bold sm:mb-3 sm:text-xl">Unlimited Connections</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Send unlimited interests and connect with more profiles daily to increase your
            ...
            <Card variant="elevated" className="group text-center">
              <CardContent className="p-4 sm:p-6 md:p-8">
                ...
                <h3 className="mb-2 text-lg font-bold sm:mb-3 sm:text-xl">Verified Badge</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Stand out with a verified badge that shows you&apos;re genuine and serious about
            ...
            <Card variant="elevated" className="group text-center">
              <CardContent className="p-4 sm:p-6 md:p-8">
                <div className="from-primary/20 to-primary/10 shadow-premium-md mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br transition-transform group-hover:scale-110 sm:mb-6 sm:h-16 sm:w-16">
                  <Zap className="text-primary h-6 w-6 sm:h-8 sm:w-8" />
                </div>
                <h3 className="mb-2 text-lg font-bold sm:mb-3 sm:text-xl">Priority Support</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Get dedicated support from our team to help you navigate and make the most of your
                  matchmaking journey.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="mx-auto max-w-3xl space-y-4 sm:space-y-6">
            <Card variant="elevated">
              <CardContent className="p-6">
                <h3 className="mb-2 text-lg font-bold">Can I upgrade or downgrade my plan?</h3>
                <p className="text-muted-foreground">
                  Yes, you can upgrade to a higher plan at any time. However, downgrades are not
                  supported during an active subscription period.
                </p>
              </CardContent>
            </Card>
            ...
            <Card variant="elevated">
              <CardContent className="p-6">
                <h3 className="mb-2 text-lg font-bold">What payment methods do you accept?</h3>
                <p className="text-muted-foreground">
            ...
            <Card variant="elevated">
              <CardContent className="p-6">
                <h3 className="mb-2 text-lg font-bold">Is my payment information secure?</h3>
                <p className="text-muted-foreground">
                  Absolutely! We use industry-standard encryption and never store your card details.
            ...
            <Card variant="elevated">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  Your account will automatically revert to the Free plan. You&apos;ll retain access
                  to your profile and basic features, but premium features will be locked.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="from-primary via-primary to-primary/90 relative overflow-hidden bg-gradient-to-br py-12 text-white sm:py-16 md:py-24">
        ...
        <div className="container-wide relative z-10 px-4 text-center sm:px-6 md:px-8">
          <h2 className="mb-4 text-2xl font-bold tracking-tight sm:mb-6 sm:text-3xl md:text-5xl">
            Ready to Find Your Perfect Match?
          </h2>
          <p className="mx-auto mb-6 max-w-2xl text-base leading-relaxed opacity-95 sm:mb-8 sm:text-lg md:mb-10 md:text-xl">
